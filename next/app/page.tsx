    ...
    <>
      <div className="homepage">
        ...
        <div id="home" className="inner-homepage">
          <div className="fade-on-load w-full py-20 px-24 max-[700px]:px-6">
            <div className="max-w-5xl mx-auto">
            <h1 className="font-bold text-[clamp(2.75rem,6vw,4.5rem)] leading-tight mb-6 w-full !text-left">
              <TypewriterName />
            </h1>
              <div className="text-[clamp(0.85rem,1.5vw,1.05rem)] leading-relaxed text-gray-300 space-y-4">
                <p>
                  I am a Software Engineer focused on building resilient,
                  scalable distributed systems that solve real-world operational
                  challenges. Currently a CS Senior at RIT, I’ve spent my recent
                  co-ops moving beyond just writing code to architecting
                ...
                <p>
                  ...
                  DevOps, leveraging tools like Go, Kubernetes, and Terraform to
                  ensure system modularity and high availability.
                </p>
          ...
          <h1
            id="experience"
            className="font-bold text-[clamp(1.95rem,6vw,3.5rem)] leading-tight"
          >
            Experience
          </h1>
