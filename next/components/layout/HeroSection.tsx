    ...
    <section className="fade-on-load min-h-screen flex flex-col justify-center px-24 max-[700px]:px-6 py-20">
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div
          ...
          style={{ opacity: scrolled ? 0 : 1, transform: scrolled ? "translateY(-12px)" : "translateY(0)", pointerEvents: scrolled ? "none" : "auto" }}
        >
          <div className="text-[clamp(0.85rem,1.5vw,1.05rem)] text-gray-300 space-y-4">
            <FadeIn delay={800}>
              <p>
                ...
                senior at RIT, and through recent co-ops and projects I've
                moved past just writing code and into designing solutions built
                for production.
              </p>
            </FadeIn>
                  ...
                  <li>
                    ...
                    <ul className="list-disc pl-5 mt-1">
                      <li>
                        ...
                        <a href="/#experience" className="text-white underline underline-offset-2">
                          /experience
                        </a>{" "}
                        for more details).
                      </li>
          ...
          <FadeIn delay={2200}>
            <div className="flex gap-3 flex-wrap mt-8 justify-center">
              <ClearPill href="https://github.com/christine-morgado" icon={GH_ICON}>
                GitHub
              </ClearPill>
              <ClearPill href="https://www.linkedin.com/in/christine-morgado/" icon={LI_ICON}>
                LinkedIn
              </ClearPill>
